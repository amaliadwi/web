		...
		echo '
			...
			<div class="col-md-8">
				<h3 style="margin-bottom: -20px;">Daftar User</h3>
					<a href="./admin.php?hlm=user&aksi=baru" class="btn btn-info btn-s pull-right">Tambah User</a>
				<br/><hr/>
	 			...
	 			echo '
				   ...
				   <tr>
					...
					<script type="text/javascript" language="JavaScript">
					 ...
					 <a href="?hlm=user&aksi=edit&id_user='.$row['id_user'].'" class="btn btn-primary btn-s">Edit</a>
					 <a href="?hlm=user&aksi=hapus&submit=yes&id_user='.$row['id_user'].'" onclick="return konfirmasi()" class="btn btn-warning btn-s">Hapus</a>
