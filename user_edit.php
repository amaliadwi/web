...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "UPDATE user SET level='$level', username='$username', nama='$nama' WHERE id_user='$id_user'");
...
<form method="post" action="" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="./admin.php?hlm=user" class="btn btn-warning">Batal</a>
		</div>
	</div>
</form>
<?php
